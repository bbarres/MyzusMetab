...
#CYP6CY3
barplot(names.arg=sumDat$clone.ID,height=sumDat$CY3_CN,xlab="",
        ylim=c(0,10),main="",las=2,border="black",cex.lab=0.8,
...
mtext(side=1,at=c(8,21,28.5),line=4.6,
      text=expression(81^RR,81^RT,81^TT),cex=0.9)
mtext(side=3,at=1.5,line=0,text="A",cex=1.7)

#CY4
barplot(names.arg=sumDat$clone.ID,height=sumDat$CY4_CN,xlab="",
        ylim=c(0,10),main="",las=2,border="black",cex.lab = 0.8,
        col=colovec[sumDat$nAChR.81],cex.names=0.7,
        space=espace_entre_barre,axisnames=F)
coord<-barplot(plot=F,names.arg=sumDat$clone.ID,height=sumDat$CY4_CN,
               space=espace_entre_barre)
...
#CY3 ARN
barplot(names.arg=sumDat$clone.ID,height=sumDat$CY3_EXP,xlab="",
        ylim=c(0,33),main="",las=2,border="black",cex.lab = 0.8,
        col=colovec[sumDat$nAChR.81],space=espace_entre_barre,
        axisnames=F)
...
axis(1,at=c(-5,coord),labels=rep("",length(coord)+1))
mtext(side=1,at=c(-5,coord),line=3.6,
      text=c("",as.character(sumDat$clone.ID)),
      col=c("white",colovec[sumDat$nAChR.81]),las=2,cex=0.5,adj=0)
mtext(side=1,at=c(8,21,28.5),line=4.2,
      text=expression(81^RR,81^RT,81^TT),cex=0.9)
...
coord<-barplot(plot=F,names.arg=sumDat$clone.ID,
               height=sumDat$CY23_EXP,space=espace_entre_barre)
